  ...
  constructor() {
    ...
    this.material = new THREE.RawShaderMaterial({
      ...
      uniforms: {
        ...
        u_outlineColor: { value: new THREE.Color(0, 0, 0) },
        u_levels: { value: 5.0 }
      },
    ...
    this.gui = new GUI();
    this.gui.add(this.material.uniforms.u_amplitude, 'value', 0.0, 2.0).name('Amplitude');
    ...
    this.gui.addColor(this.material.uniforms.u_outlineColor, 'value').name('Outline Color');
    this.gui.add(this.material.uniforms.u_levels, 'value', 1, 10).name('Toon Levels');
